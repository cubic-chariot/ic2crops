import { mergeWeightLists } from './Weights.js';
...
export class StaticCropData {
    constructor() {
         ...
         */
        this.atopHydratedFarmland = false;
     ...
     */
    computeGainedGrowthPoints(nutrientStorage = 0) {
     ...
     */
    computeAverageGrowthPointsWithNutrition() {
        let growthPoints = [];
    ...
    static computeExpectedStepsInGrowthStage(growthStageDuration, growthPointGainsProbabilities) {
